...
h3. Can we query the location manager directly or do we need to save reported locations?
...
h3. Does Best Accuracy not bother sending _lower_ readings?
...
h3. Do we continue to get readings after we've reached the 'best'
